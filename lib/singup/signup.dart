...
import '../controllers/auth_controller.dart'; // Note: File name should match the case of the actual file
...
//   final bool Function() isLoading; // Getter for _isLoading
//   final void Function(bool) setIsLoading; // Setter for _isLoading
...
//       return;
//     }
//     if (!emailController.text.trim().contains(RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$'))) {
...
//   // Public method to trigger signup
...
//       setIsLoading: (value) => setState(() => _isLoading = value),
//       agreeToTerms: _agreeToTerms,
//     );
//   }
...
//     // Update context in AuthController after widget is built
//     _authController = AuthController(
//       context: context,
//       nameController: _nameController,
//       emailController: _emailController,
...
//                           setState(() {
//                             _agreeToTerms = value ?? false;
//                             // Update AuthController with new agreeToTerms value
//                             _authController = AuthController(
//                               context: context,
//                               nameController: _nameController,
//                               emailController: _emailController,
